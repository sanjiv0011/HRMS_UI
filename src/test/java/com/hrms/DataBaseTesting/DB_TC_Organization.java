package com.hrms.DataBaseTesting;
...
public class DB_TC_Organization {
	public WebDriver driver;
	public static final Logger logger = LogManager.getLogger(DB_TC_Organization.class);
	
	
	public void test_DB_TC_Organization(String orgName, String orgCode, String orgEmail, String orgPhoneNumber, String orgAddress, String orgArea, String orgCity, String orgState, String orgPostalCode, String orgCountry, String orgTimeZone) throws SQLException, InterruptedException
	{		Thread.sleep(2000); //WAITNG TO AVOID DATA INCONSISTANCY PROBLEM
			...
			logger.info("===>>> Database Testing Call Done");
	}
}
