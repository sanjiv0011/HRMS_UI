...
public static final Logger logger = LogManager.getLogger(Action_Restore.class);
	...
	public static void activate(String searchKey, WebElement searchBox, WebElement label, WebElement btnAction, WebElement actionActivate, WebElement btnYes, String confirmMessage ) throws InterruptedException
	{
